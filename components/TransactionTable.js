      ...
      <Table sx={{ minWidth: 500 }} aria-label="transactions table">
        <TableHead>
          <TableRow sx={{ backgroundColor: "#c3c5c6" }}>
            ...
            <TableCell align="center">Merchant Reference</TableCell>
          </TableRow>
        </TableHead>
        ...
        <TableBody>
          {(rowsPerPage > 0
            ...
            <TableRow key={row.id}>
              ...
              <TableCell align="center">{row.payment_option}</TableCell>
              <TableCell align="center">{row.transaction_date}</TableCell>
              <TableCell align="center">{row.currency}</TableCell>
              <TableCell align="center">{row.merchant_reference}</TableCell>
            </TableRow>
          ))}
